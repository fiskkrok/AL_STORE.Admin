        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterializedPath = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DimensionWeight = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DimensionWidth = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DimensionHeight = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DimensionLength = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products_Attributes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ProductVariants_Attributes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariants_Attributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariants_Attributes_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Attributes_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_Attributes_ProductVariantId",
                table: "ProductVariants_Attributes",
                column: "ProductVariantId");
        }
