...
//[JsonSerializable(typeof(ProductTypeDto))]
//[JsonSerializable(typeof(List<ProductTypeDto>))]
...
//[JsonSerializable(typeof(Result<ProductTypeDto>))]
...
//[JsonSerializable(typeof(Result<List<StockItemDto>>))]
//[JsonSerializable(typeof(Result<List<OrderDto>>))]
//[JsonSerializable(typeof(Result<List<CategoryDto>>))]
//[JsonSerializable(typeof(Result<List<ProductTypeDto>>))]
